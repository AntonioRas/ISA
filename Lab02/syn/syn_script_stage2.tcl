# script to synthesize and report area and timing with fmax  - modified stage2


# constant values
set min_clk_period 1.42
# 0.63
...
# save results
report_resources > ./report_resources_ultra_maxfreq.txt
report_timing > ./report_timing_ultra_maxfreq.txt
report_area > ./report_area_ultra_maxfreq.txt
