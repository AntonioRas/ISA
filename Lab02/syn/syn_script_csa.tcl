# script to synthesize and report area and timing with fmax CSA


# constant values
set min_clk_period 4.24
...
# save results
report_resources > ./report_resources_csa_maxfreq.txt
report_timing > ./report_timing_csa_maxfreq.txt
report_area > ./report_area_csa_maxfreq.txt
