...
# save results
report_resources > ./report_resources_mbe_opt_reg_maxfreq.txt
report_timing > ./report_timing_mbe_opt_reg_maxfreq.txt
report_area > ./report_area_mbe_opt_reg_maxfreq.txt
