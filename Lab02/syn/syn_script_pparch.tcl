# script to synthesize and report area and timing with fmax PPARCH

# constant values
set min_clk_period 1.56
...
# save results
report_resources > ./report_resources_pparch_maxfreq.txt
report_timing > ./report_timing_pparch_maxfreq.txt
report_area > ./report_area_pparch_maxfreq.txt
