...
# save results
report_resources > ./report_resources_reg_maxfreq.txt
report_timing > ./report_timing_reg_maxfreq.txt
report_area > ./report_area_reg_maxfreq.txt
