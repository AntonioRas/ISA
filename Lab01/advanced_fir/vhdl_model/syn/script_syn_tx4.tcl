...
# save results
report_timing > ./report_timing2.txt
report_area > ./report_area2.txt


# save netlist
ungroup -all -flatten
change_names -hierarchy -rules verilog
write_sdf ../netlist/FIR_unfolding_pipeline2_filter.sdf
write -f verilog -hierarchy -output ../netlist/FIR_unfolding_pipeline2_filter.v
write_sdc ../netlist/FIR_unfolding_pipeline2_filter.sdc
